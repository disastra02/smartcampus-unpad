<div class="content-wrapper">
  <h4>
  Evaluasi <small class="text-muted">/ Tambah Nilai</small>
  </h4>
  <hr>
  <div class="row">
              ...
              <p class="card-description">
               ...
               <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="siswa" name="id_siswa" style="font-weight: bold;background-color: #212121;color: #fff;" required>
                  <option>-- Pilih --</option>
                  <?php
                  $sqlSiswa=mysqli_query($con, "SELECT * FROM tb_siswa ORDER BY id_siswa DESC");
                ...
                <button type="submit" name="tugasSaveNilai" class="btn btn-info mr-2">Simpan</button>
